...
CDOC C                          components.
CDOC LOGICAL          SUFAIL <  Logical flag for stress update procedure
CDOC C                          failure. Set to .TRUE. if the algorithm
CDOC C                          failed to update the stress. Set to
CDOC C                          .FALSE. is the stress was successfully
CDOC C                          updated.
CDOC END_PARAMETERS
CHST
