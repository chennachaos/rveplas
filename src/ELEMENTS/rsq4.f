CDOC BEGIN_SUBROUTINE RSQ4
CDOC Read input and set properties for element type QUAD4
CDOC
CDOC This routine reads data from the input data file and sets the
CDOC element properties arrays for elements type QUAD4: Standard
CDOC isoparametric 4-noded quadrilateral for plane strain, plane stress
...
C Issue error message and abort program execution in case of I/O error
  100 CALL ERRPRT('ED0205')
C
  200 CONTINUE
      RETURN
      END
CDOC END_SUBROUTINE RSQ4
