CDOC BEGIN_SUBROUTINE SFQ4FB
CDOC Shape function and derivatives for element type QUA4FB
CDOC
CDOC This routine computes the shape functions and shape function
CDOC derivatives for the element type QUA4FB: F-bar isoparametric
CDOC 4-noded quadrilateral for plane strain and axisymmetric analysis.
CDOC
