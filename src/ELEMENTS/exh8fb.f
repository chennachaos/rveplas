CDOC BEGIN_SUBROUTINE EXH8FB
CDOC Sets Gauss point-node extrapolation matrix for element type 
CDOC HEXA_8_FBAR
CDOC
...
CDOC HEXA_8_FBAR: F-bar isoparametric 8-noded tri-linear hexahedron.
CDOC
...
C TO NODES FOR ELEMENT TYPE 'HEXA_8_FBAR' (F-BAR 8-NODED TRI-LINEAR
C HEXAHEDRON)
C
