CDOC BEGIN_SUBROUTINE RST3
CDOC Set properties arrays for element type TRI3
CDOC
CDOC This routine sets the element properties arrays for elements type
CDOC TRI3: Standard isoparametric 3-noded triangle for plane strain,
CDOC plane stress and axisymmetric analysis. It also echoes the
CDOC properties to the results file and sets the unsymmetric tangent
CDOC stiffness flag.
CDOC
