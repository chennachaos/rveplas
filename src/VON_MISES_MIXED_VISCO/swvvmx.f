CDOC BEGIN_SUBROUTINE SWVVMX
CDOC Initialise/switch variables - von Mises viscopl. mixed hard. model
CDOC
CDOC This initialises and switches state variables (between current and
CDOC previous values) for the von Mises elasto-viscoplastic material
CDOC model with mixed isotropic/kinematic hardening and Peric's power
CDOC law for viscoplastic flow.
CDOC
