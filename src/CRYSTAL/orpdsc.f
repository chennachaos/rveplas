CDOC BEGIN_SUBROUTINE ORPDSC
CDOC Output results for the planar double-slip single crystal model
CDOC
CDOC This routine writes to the results file the internal and
CDOC algorithmic variables of the planar double-slip single crystal
CDOC elasto-plastic material model with non-linear isotropic Taylor
CDOC hardening.
CDOC
