...
CDOC tangent modulus, a, for the planar double slip single crystal
...
CDOC algorithm implemented in subroutine SUPDSC.
...
CDOC C                          SUPDSC. All multipliers are set to zero
...
CDOC END_PARAMETERS
CHST
CHST E.de Souza Neto, November 1998: Initial coding (Miehe's approxim.)
CHST E.de Souza Neto, December 1998: Exact elasto-plastic tangent coded
CHST
      SUBROUTINE CSTPDS
