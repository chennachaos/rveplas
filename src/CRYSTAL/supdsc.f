...
CDOC C                          This array is set in routines INDATA and
CDOC C                          RDTR.
...
CDOC C                          flag, IFPLAS, the state update failure
CDOC C                          flag, SUFAIL and the active slip-system
CDOC C                          flags, S1ACT, S2ACT, S3ACT and S4ACT.
...
CDOC C                          .TRUE. only if the
CDOC C                          corresponding system is currently
CDOC C                          active, i.e., S1ACT is set to .TRUE.
CDOC C                          if system 1 is active, S2ACT is set to
CDOC C                          .TRUE. if system 2 is active and so on.
CDOC C                          Each flag will be set to .FALSE. if the
CDOC C                          corresponding system is not currently
CDOC C                          active.
