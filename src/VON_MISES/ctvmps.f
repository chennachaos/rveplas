...
CDOC algorithm for the von Mises model coded in subroutine SUVMPS.
...
CDOC C                          matrix (the standard plane stress linear
CDOC C                          elasticity matrix).
CDOC C                          If .TRUE., DMATX returns as the
CDOC C                          elasto-plastic tangent consistent with
CDOC C                          the plane stress-projected return
CDOC C                          mapping algorithm implemented in routine
CDOC C                          SUVMPS.
...
CDOC C                          Current values (outcome of SUVMPS).
...
CDOC C                          components (outcome of SUVMPS).
CDOC END_PARAMETERS
CHST
